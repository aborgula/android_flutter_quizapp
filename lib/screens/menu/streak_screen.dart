...
class StreakScrean extends GetView<MyZoomDrawerController> {
  const StreakScrean({Key? key}) : super(key: key);
                                  ...
                                  children: [
                                    ...
                                    Obx(() {
                                      ...
                                      return FutureBuilder<int>(
                                        future: authController.getUserStreak(),
                                        builder: (context, snapshot) {
                                          int userStreak = snapshot.data ?? 0;
                                          return Text(
                                            '$userStreak days',
